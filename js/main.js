...
let swpbtn = document.getElementById("button");
...
function startTimer() {
    ...
    if (timer2.isRunning == true) {
        if (timer2.minutes == 0 && timer2.seconds == 0) {
            // endScreen.style.visibility = "visible"sss
            rstbtn.click();
        }
...
swpbtn.addEventListener("click", swap)
